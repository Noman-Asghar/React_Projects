...
import carImg from "../assets/expert-img.jpg"
...
const Home = ({name}) => {
  ...
  return (
    <>
   <div className="flex pt-24 w-full  xl:pt-0 justify-around min-h-screen items-center overflow-hidden flex-wrap  px-2">
              <div className="max-w-xl text-black ">
                 <h1 className="font-jostBold text-blue-800 mb-2 text-[58px] leading-[50px] sm:text-7xl">
                  {name}
                </h1>
              ...
              <div className="relative h-full">
                ...
                <div className="flex justify-center bg-black items-center h-[500px] flex-wrap  mt-[60px]">
                <Cart username="Noman"/>
                <Cart username="Hamdan" image={carImg}/>
                <Cart username="Noman Asghar"/>
                <Cart username="Hamdan Asghar" image={carImg}/>
              </div>
              </>
  )
}
